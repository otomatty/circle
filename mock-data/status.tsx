...
export const status: Status[] = [
  ...
  { id: 'completed', name: '完了', color: '#8b5cf6', icon: CompletedIcon },
  { id: 'paused', name: '一時停止', color: '#0ea5e9', icon: PausedIcon },
  { id: 'to-do', name: '未着手', color: '#f97316', icon: ToDoIcon },
  { id: 'backlog', name: 'バックログ', color: '#ec4899', icon: BacklogIcon },
];
